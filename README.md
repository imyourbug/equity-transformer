...
```bash
python run.py --graph_size 500 --problem mtsp --run_name 'mtsp500' --agent_min 2 --agent_max 10 --batch_size 4
```
...
python run.py --graph_size 500 --problem mtsp --load_path pretrained/mtsp/mtsp500/epoch-0.pt --batch_size 32 --agent_min 2 --agent_max 10 --ft Y
```
